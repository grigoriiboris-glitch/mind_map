<template>
  <b-list-group class="listGroup thin-scroll">
    ...
    <b-list-group-item class="listGroupItem">
      <span class="notificationIcon thumb-sm">
        <img class="rounded-circle" src="../../../assets/people/a5.jpg" alt="woman" />
      </span>
      <p class="m-0 overflow-hidden">
    ...
    <b-list-group-item class="listGroupItem">
      ...
      <p class="m-0 overflow-hidden">
        ...
        &nbsp;&nbsp;
        <el-button size="xs" type="success" class="me-1">Allow</el-button>
        <el-button size="xs" type="danger">Deny</el-button>
        <time class="help-block m-0">
          12:18 AM
        </time>
      </p>
